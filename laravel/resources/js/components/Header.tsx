...
export default function Header(){
    ...
    return(
        <header className='bg-[#212121] py-12 px-5 flex justify-between items-center'>
            ...
            <nav className='flex gap-10 pr-6'>
                {auth.user ? (
                    <>
                        ...
                        <Button onClick={() => router.post('logout')} className=" px-5 py-2 text-l w-full rounded bg-red-900 data-hover:bg-red-800 hover:cursor-pointer">Logout</Button>{/*Link es button solo para logout :clown: */}
                    </>
                ) : (
                    <>
