...
/**
 * Title: Contact 002
 * Slug: media-magazine/contact-002
 * Categories: contact
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-superbfont-small-font-size"><?php esc_html_e( 'Visit us', 'media-magazine' ); ?>
</h3>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","textColor":"contrast","fontSize":"superbfont-xlarge"} -->
<h2 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xlarge-font-size"><?php esc_html_e( 'Locate Us on the Map', 'media-magazine' ); ?>
</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"mono-2","fontSize":"superbfont-small"} -->
<p class="has-text-align-center has-mono-2-color has-text-color has-superbfont-small-font-size"><?php esc_html_e( 'Our physical presence mirrors our commitment to being a beacon of creativity and expertise.', 'media-magazine' ); ?>
</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
